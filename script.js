...
const generateStudentCard = (details) => {
  enrolledStudents.insertAdjacentHTML(
    ...
    `<div class="student-card">
      <img alt="Avatar" height="225px" src="https://thelightcommittee.com/wp-content/uploads/2022/08/womens-professional-studio-headshots-los-angeles-2.jpg" width="225px" />
      <h3>
          <em>${details.name}</em>
      </h3>
      <h3>
